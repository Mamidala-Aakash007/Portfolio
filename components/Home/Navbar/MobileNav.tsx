...
export default function MobileNav({showNav,closeNav}:Props) {
  ...
  return (
    <div>
      ...
      {/* navlinks */}
      <div className={`text-white ${navOpen} fixed justify-center flex flex-col transform transition-all duration-500 delay-300 w-[80%] h-full sm:w-[60%] bg-cyan-800 space-y-6 z-[100050] right-0`}>
        {NavLinks.map((link) => {
          return (
